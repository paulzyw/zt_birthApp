...
export function Scene3_Celebration({ onComplete }: { onComplete: () => void; key?: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="fixed top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 text-[11rem] sm:text-[20rem] lg:text-[30rem] font-bold text-[#ffea00]/[1.0] select-none z-0 tracking-tighter pointer-events-none">
        20
      </div>
